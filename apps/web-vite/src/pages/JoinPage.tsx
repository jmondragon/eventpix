...
export default function JoinPage() {
    ...
    // const code = params.code as string; // Already destructured
    ...
    useEffect(() => {
        if (authStatus === 'success' && event && event.join_mode !== 'pin') {
            ...
            router.push(`/event/${event.id}`, 'forward', 'replace');
        }
                ...
                <div className="flex h-screen flex-col items-center justify-center bg-gray-950 text-white p-4">
                    ...
                    <div className="w-full max-w-sm space-y-4">
                                ...
                                <div className="flex justify-center gap-3 mb-2">
                                    {digits.map((digit, index) => (
                                        <input
                                            ...
                                            inputMode="numeric"
                                            maxLength={1}
                                            className="w-12 h-14 text-center text-2xl font-bold bg-black border border-gray-700 rounded-xl focus:border-blue-500 focus:outline-none transition-all focus:ring-2 focus:ring-blue-500/40"
                                            value={digit}
                        ...
                        <button
                            ...
                            className="w-full h-16 btn-premium bg-gradient-to-br from-blue-600 via-blue-500 to-blue-700 text-white text-lg font-black tracking-wider rounded-2xl shadow-premium glow-blue active:scale-[0.97] disabled:opacity-50 disabled:cursor-not-allowed"
                        >
