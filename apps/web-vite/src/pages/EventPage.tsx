...
export default function EventPage() {
    ...
    // const id = params.id as string; // Already destructured from useParams
                ...
                <div className="min-h-screen bg-gray-950 pb-20">
                    ...
                    <header className="sticky top-0 z-10 bg-gray-900/80 backdrop-blur-md border-b border-gray-800 p-4 flex justify-between items-center">
                        <div className="w-8">
                            ...
                            <button onClick={() => router.push('/', 'back', 'push')} className="text-gray-400 hover:text-white">
                        ...
                        <div className="flex justify-end gap-2 items-center">
                            ...
                            <button
                                onClick={() => router.push(`/event/${id}/slideshow`, 'forward', 'push')}
                                className="text-gray-400 hover:text-white p-2"
                    ...
                    <div className="fixed bottom-6 right-6 flex flex-col items-center gap-4">
                        ...
                        <button
                            ...
                            disabled={uploading}
                            className="btn-premium bg-gray-800/80 hover:bg-gray-700 glass text-white rounded-full p-3 shadow-premium active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed"
                        ...
                        <button
                            ...
                            disabled={uploading}
                            className="btn-premium bg-gradient-to-tr from-blue-700 via-blue-500 to-blue-400 text-white rounded-full p-6 shadow-premium glow-blue active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed"
                            title="Take Photo"
                        >
                            {uploading ? (
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="flex justify-end gap-3 mt-6 pt-2 border-t border-gray-800">
                                        ...
                                        <button
                                            ...
                                            className="h-14 btn-premium bg-gradient-to-r from-purple-700 via-purple-600 to-purple-500 text-white font-black tracking-wide px-8 rounded-2xl shadow-premium glow-purple"
                                        >
                                            Save Changes
                                        </button>
                                    </div>
